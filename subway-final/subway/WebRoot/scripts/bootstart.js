...
var bootPATH = __CreateJSPath("bootstart.js");

var basePath = bootPATH.substring(0, bootPATH.indexOf("scripts"));
...
document.write('<script src="' + bootPATH
		+ 'jquery-1.6.2.min.js" type="text/javascript"></script>');
document.write('<script src="' + bootPATH
		+ 'miniui/miniui.js" type="text/javascript" ></script>');
document
		.write('<link href="'
				+ bootPATH
