...
<!-- @page
 ...
 -->  </style>
  ...
  <body>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl73" height="260" rowspan="4" style='height:195.00pt;border-right:.5pt solid windowtext;border-bottom:1.0pt solid windowtext;' x:str>信号车间</td>
    <td class="xl74" x:str>正线</td>
    <td class="xl74"><%benyue=mrb.geteverymajoruserowner("信号","正线",0,0);benyue1=benyue;%><%=benyue%></td>
    <td class="xl74"><%yichuli=mrb.geteverymajoruserowner("信号","正线",0,1);yichuli1=yichuli;%><%=yichuli%></td>
    <%shangyue=mrb.geteverymajoruserowner("信号","正线",1,0);
...
<script type="text/javascript">
	var myData = new Array(['正线一工班', <%=benyue1%>, <%=yichuli1%>],['车载工班', <%=benyue3%>, <%=yichuli3%>],['车辆段工班', <%=benyue4%>, <%=yichuli4%>],['ATS工班', <%=benyue5%>, <%=yichuli5%>]);
