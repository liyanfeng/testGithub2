...
%>
  <table width="964" border="0" cellpadding="0" cellspacing="0" style='width:723.00pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="19" style='height:14.25pt;'>
    ...
    <td class="xl95" colspan="4" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>2014年7月故障统计表（统计日:2014-7-25 17:00）</td>
    <td class="xl183"></td>
   </tr>
   <tr height="19" style='height:14.25pt;'>
    <td class="xl91" height="19" style='height:14.25pt;'></td>
   ...
   <table width="500px" style="table-layout : auto | fixed;">
   <tr height="32" style='height:24.00pt;'>
   ...
   <tr>
    <td><%=fault.getMajor() %></td>
    <td><%=fault.getUserowner() %></td>
    <td><%=fault.getFinder() %></td>
    <td><%=fault.getAccepter() %></td>
    <td><%=fault.getPdate() %></td>
    <td><%=fault.getPtime() %></td>
    <td><%=fault.getBacktime() %></td>
    <td><%=fault.getPlace() %></td>
    <td><%=fault.getPresent() %></td>
    <td><%=fault.getProcess() %></td>
   </tr>
  <%
  }
     %>
