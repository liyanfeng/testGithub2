...
<!-- @page
 ...
 <script type="text/javascript">
  ...
  <body>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl73" height="260" rowspan="5" style='height:195.00pt;border-right:.5pt solid windowtext;border-bottom:1.0pt solid windowtext;' x:str>车载工班</td>
    <td class="xl74" x:str>硬件故障</td>
    <td class="xl74"><%  benyue = mrb.getuserowner("车载","硬件故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("车载","硬件故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("车载","硬件故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("车载","软件故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("车载","软件故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("车载","软件故障", 1, 0); %><%=shangyue %></td>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("车载","接地故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("车载","接地故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("车载","接地故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
        <script type="text/javascript">
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("车载","人为故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("车载","人为故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("车载","人为故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
        <script type="text/javascript">
...
<td class="xl74"><%  benyue = mrb.getuserowner("车载","正常报警", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("车载","正常报警", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("车载","正常报警", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
        <script type="text/javascript">
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
	...
	gongban('车载工班月报表数据（件/月）',myData,'车载工班月报表');
</script>
