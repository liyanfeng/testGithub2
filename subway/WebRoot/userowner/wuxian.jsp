...
<!-- @page
 ...
 -->  </style>
  ...
  <body>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl73" height="260" rowspan="5" style='height:195.00pt;border-right:.5pt solid windowtext;border-bottom:1.0pt solid windowtext;' x:str>无线工班</td>
    <td class="xl74" x:str>硬件故障</td>
    <td class="xl74"><%  benyue = mrb.getuserowner("无线","硬件故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("无线","硬件故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("无线","硬件故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("无线","软件故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("无线","软件故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("无线","软件故障", 1, 0); %><%=shangyue %></td>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("无线","接地故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("无线","接地故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("无线","接地故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
    <script type="text/javascript">
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl74"><%  benyue = mrb.getuserowner("无线","人为故障", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("无线","人为故障", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("无线","人为故障", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
    <script type="text/javascript">
...
<td class="xl74"><%  benyue = mrb.getuserowner("无线","正常报警", 0, 0); %><%=benyue %></td>
    <td class="xl74"><% yichuli=mrb.getuserowner("无线","正常报警", 0, 1); %><%=yichuli %></td>
    <td class="xl74"><% shangyue=mrb.getuserowner("无线","正常报警", 1, 0); %><%=shangyue %></td>
    <td class="xl75" x:str><% baifen=(shangyue==0)?0:((benyue-shangyue)*100)/shangyue; %><%=baifen %>%
    <script type="text/javascript">
...
<script type="text/javascript">
	...
	gongban('无线工班月报表数据（件/月）',myData,'无线工班月报表');
</script>
